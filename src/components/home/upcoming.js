...
import pages3 from "../../assets/images/pages/03.png";
import pages4 from "../../assets/images/pages/04.png";
import pages17 from "../../assets/images/pages/17.png";
import pages18 from "../../assets/images/pages/18.png";
import pages16 from "../../assets/images/pages/16.png";
...
const Upcoming = (props) => {
  ...
  const [slidePerV, setSlidePV] = useState(3);
                ...
                <div class="swiper-slide">
                  <div class="card tournament-card">
                    <div class="card-header">
                      <img
                        src={pages2}
                        class="img-fluid iq-img iq-img-shadow-blue"
                        alt="img8"
                      />
                      <span class="text-primary tournament-label">SEPT 02</span>
                      <span class="tournament-label d-inline-block ms-3">
                        STARTING AT 6.00 AM
                      </span>
                      <h6 class="mt-4 tournament-title">The Shore</h6>
                    </div>
                    <div class="card-body d-flex justify-content-between">
                      <div>
                        <h6 class="text-primary tournament-label">Prize</h6>
                      ...
                      <div>
                        <h6 class="tournament-label text-primary">Team size</h6>
                        <span class="tournament-label">
                          <svg
                            width="16"
                            height="16"
                      ...
                      <div>
                        <h6 class="tournament-label text text-primary">
                          Sponsor
                        </h6>
                        <span class="tournament-label">
                          <svg
                  ...
                  <div class="card tournament-card">
                    <div class="card-header">
                      <img
                        ...
                        alt="img8"
                      />
                      <span class="text-primary tournament-label">SEPT 03</span>
                      <span class="tournament-label d-inline-block ms-3">
                        STARTING AT 6.00 PM
                      </span>
                      <h6 class="mt-4">BattleField 1</h6>
                    </div>
                    <div class="card-body d-flex justify-content-between">
                      <div>
                        <h6 class="text-primary tournament-label">Prize</h6>
                  ...
                  <div class="card tournament-card">
                    <div class="card-header">
                      <img
                        ...
                        alt="img8"
                      />
                      <span class="text-primary tournament-label">SEPT 04</span>
                      <span class="tournament-label d-inline-block ms-3">
                        STARTING AT 8.00 PM
                      </span>
                      <h6 class="mt-4">Outriders</h6>
                    </div>
                    <div class="card-body d-flex justify-content-between">
                      <div>
                        <h6 class="text-primary tournament-label">Prize</h6>
                  ...
                  <div class="card tournament-card">
                    <div class="card-header">
                      <img
                        ...
                        alt="img8"
                      />
                      <span class="text-primary tournament-label">OCT 02</span>
                      <span class="tournament-label d-inline-block ms-3">
                        STARTING AT 6.00 AM
                      </span>
                      <h6 class="mt-4">Doom Eternal</h6>
                    </div>
                    <div class="card-body d-flex justify-content-between">
                      <div>
                        <h6 class="text-primary tournament-label">Prize</h6>
                  ...
                  <div class="card tournament-card">
                    <div class="card-header">
                      <img
                        ...
                        alt="img8"
                      />
                      <span class="text-primary tournament-label">OCT 05</span>
                      <span class="tournament-label d-inline-block ms-3">
                        STARTING AT 8.00 PM
                      </span>
                      <h6 class="mt-4">BattleGround</h6>
                    </div>
                    <div class="card-body d-flex justify-content-between">
                      <div>
                        <h6 class="text-primary tournament-label">Prize</h6>
                  ...
                  <div class="card tournament-card">
                    <div class="card-header">
                      <img
                        ...
                        alt="img8"
                      />
                      <span class="text-primary tournament-label">OCT 07</span>
                      <span class="tournament-label d-inline-block ms-3">
                        STARTING AT 9.00 PM
                      </span>
                      <h6 class="mt-4">Grant Theft Auto</h6>
                    </div>
                    <div class="card-body d-flex justify-content-between">
                      <div>
                        <h6 class="text-primary tournament-label">Prize</h6>
